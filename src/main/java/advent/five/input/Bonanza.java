...
public class Bonanza extends Thread {
    ...
    private Long start;
    private Long end;
    public Bonanza(Long start, Long end) {
        this.start = start;
        this.end = end;
    }
    ...
    public void setSeedRange() {
        ...
        long temp = 0L;
        System.out.println("Thread: " + this.getName() + " started with start: " + start + " -- end: " + end);
        for (long j = start; j <= end; j++) {
            ...
            if(temp < smallestSeedLocation) {
                ...
                System.out.println("TEMP IS SET HERE WITH: " + j + " AND TEMP: " + temp);
            }

        }
        if(smallestSeedLocation < 80000000)
            System.out.println("Smallest Location is: " + smallestSeedLocation + " START - END " + start + " - " + end);
    }
    ...
    private String seedString = "3007537707 503983167";
